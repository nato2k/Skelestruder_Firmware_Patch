...
sreplace='#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,980}'
strreplace(replacefile,sfind,sreplace)
...
sreplace='#define TMC2130_USTEPS_E    16        // microstep resolution for E axis'
strreplace(replacefile,sfind,sreplace)
